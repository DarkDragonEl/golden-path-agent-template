...
also a hard failure -- silent network failures are exactly the class of
...
KEYCLOAK_HOST = "golden-path-agent-service.golden-path-agent-keycloak.svc.cluster.local"
