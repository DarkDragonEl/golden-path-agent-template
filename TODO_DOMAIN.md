...
| `agent/prompts/decide_system_prompt.md` / `agent/prompts/generate_system_prompt.md` | The agent's one business role, one knowledge domain, tone, and refusal/escalation instructions — split across the tool-decision call and the citation-bearing answer call (see ADR-004, ADR-005) |
